...
public class CustomAdapter extends BaseAdapter 
{
	...
	public CustomAdapter(Activity a, ArrayList b, ArrayList q) 
	{
	    activity = a;
	    this.title = b;
	    this.notice=q;
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		 ...
		 View vi = convertView;
		    ...
		    TextView busname = (TextView) vi.findViewById(R.id.name); 
		    String song = title.get(position).toString();
		    busname.setText(song);


		    TextView departure = (TextView) vi.findViewById(R.id.q); 
